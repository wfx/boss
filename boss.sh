...
#
# Name:   boss.sh
# Desc:   BOSS is a installer for the "Best Operating System System".
#
# Thanks to Nick, http://unicks.eu
...
# Host
echo "127.0.0.1    boss.localdomain         boss" >> /mnt/etc/hosts
